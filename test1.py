...
class TextClassifier:
    ...
    def preprocess_data(self, file_path):
        ...
        rows = []
        # Corrected regex to match ticket patterns
        ticket_pattern = re.findall(r"(Ticket\s*#[\w-]+(?:(?:\s*-\s*[^/\n\r]+)?)?)", content)

        for ticket_text in ticket_pattern:
            # Corrected regex to capture only the ticket number
...
if __name__ == "__main__":
    combined_file_path = "C:/Users/Harsha Vardhan/OneDrive/Desktop/tickets project/combined_html_content.txt"
