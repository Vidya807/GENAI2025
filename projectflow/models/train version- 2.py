...
def load_data(path):
    """C:/Users/Harsha Vardhan/Documents/projectflow/Sample - Superstore (1).xls"""
    return pd.read_excel("C:/Users/Harsha Vardhan/Documents/projectflow/Sample - Superstore (1).xls")
...
def main():
    data_path = "C:/Users/Harsha Vardhan/Documents/projectflow/Sample - Superstore (1).xls"  # Update path if needed
    features = [
        'Sales',
        'Quantity',
        'Discount',
    ...
    df = load_data("C:/Users/Harsha Vardhan/Documents/projectflow/Sample - Superstore (1).xls")
    # Add new columns
